...
additionHandler.handleRequest({ operation: 'subtract', operand1: 15, operand2: 5 });
divisionHandler.handleRequest({ operation: 'divide', operand1: 50, operand2: 5 });
multiplicationHandler.handleRequest({ operation: 'divide', operand1: 50, operand2: 0 });